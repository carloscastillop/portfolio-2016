...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"  href="{{ URL::to('icons/android-icon-192x192.png') }}?d={{date("YdmHis")}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ URL::to('icons/favicon-32x32.png') }}?d={{date("YdmHis")}}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ URL::to('icons/favicon-96x96.png') }}?d={{date("YdmHis")}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::to('icons/favicon-16x16.png') }}?d={{date("YdmHis")}}">
