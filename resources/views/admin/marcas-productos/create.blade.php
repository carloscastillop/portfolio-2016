...
<div class="row">
	<div class="col-lg-12">
		<div aria-label="Large button group" role="group" class="btn-group btn-group-lg">
			<a class="btn btn-default" href="{{ URL::to('backend/marcas-roductos') }}"><span aria-hidden="true" class="glyphicon glyphicon-list"></span> Listar todos</a> 
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	                <div class="table-responsive">
	                    ...
	                    {{ Form::open(array('url' => 'backend/marcas-productos', 'files' => true)) }}
							...
							<div class="form-group col-md-6">
						    	{{ Form::submit('Crear marca', array('class' => 'btn btn-primary btn-lg')) }}
						    </div>
