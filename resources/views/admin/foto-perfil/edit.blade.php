...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Foto perfil: {{ $categoria->id }}</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    ...
                    {{ Form::model($categoria, array('route' => array('backend.foto-perfil.update', $categoria->id), 'method' => 'PUT', 'files' => true)) }}
                            ...
                            <div class="form-group col-md-6">
                                {{ Form::label('name', 'Nombre del fondo') }}
                                {{ Form::text('name', Input::old('name'), array('class' => 'form-control')) }}
                            </div>
                            <div class="clearfix"></div>
                            
                            <div class="form-group col-md-6">
                                <img src="{{ URL::to(Config::get('settings.uploadFolderPerfilBackground').'/'.$categoria->image) }}" class="img-responsive thumbnail">
