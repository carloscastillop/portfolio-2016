...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Editar lista de  [ {{ $user->nombre_novios }} ] <br>
        <small>[user ID: {{ $user->id }}] [user email: {{ $user->email }}]</small></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body miListaContainer">
				...
				<!-- ACTUALIZAR ESTADO LISTA DESEOS-->
				{{ Form::open(array('url' => '/backend/listas/activar', 'files' => false)) }}
				<input type="hidden" id="idUsuarioLista" name="idUsuarioLista" value="{{ $user->id }}">
				...
				<div class="form-group">
			        <div class="well">
			        	<div class="pull-left">
					        <div class="checkbox">
							    <label>
							      <input type="checkbox" value="1" id="finalizada" name="finalizada" @if($user->lista()->first()->finalizado) checked="checked" @endif> 
							      Lista finalizada
							    </label>
							    <p class="help-block small"><i aria-hidden="true" class="fa fa-info-circle"></i> Una lista finalizada es cuando el usuario ya no puede mostrar su lista de regalos.</p>
							</div>
						</div>
						<div class="pull-right">
							<div style="margin-top: 10px;">
								<button id="actualizaLista" type="button" class="btn btn-primary btn-lg">Actualizar</button>
								<button id="actualizaListaConfirm" type="submit" class="btn btn-danger btn-lg" style="display:none"><i aria-hidden="true" class="fa fa-warning"></i> Confirmar</button>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
			    ...
			    <div class="clearfix"></div>
			    {{ Form::close() }}
			    <!-- FIN ACTUALIZAR ESTADO LISTA DESEOS-->
