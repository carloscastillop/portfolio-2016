        ...
        @foreach($others as $other)
            <div class="col-xs-6 col-sm-3 col-md-4">
                <div class="otherSkill">
                    <a class="fancybox" href="{{ URL::to('images/skills/'.$other->image) }}" rel="gallery_group-{{ $other->id }}" title="{{$other->description}}-1">
                    ...
                    <div class="hidden">
                        @if( count($other->gallery) > 0 )
                            ...
                            <a class="fancybox" href="{{ URL::to('images/skills/'.$leGallery->image) }}" rel="gallery_group-{{ $other->id }}" title="Lorem ipsum dolor sit amet {{$i}}-2">
